...
define(["BufferGeometry", "random", "band", "parametric", "robot", "bender", "planet", "explosion", "three", "jquery", "jQueryUI"],
        (function (BufferGeometry, Random, Band, ParametricSurface, Robot, Bender, Planet, Explosion, THREE) {
            "use strict";
            ...
            var HtmlController = function (scene) {
                $('#checkAnimate').attr('checked', true);
                $("#random").hide();
                $("#band").hide();
                $("#ellipsoid").hide();
                $("#parametric").hide();
                ...
                $("#btnExplosion").click((function () {
                    ...
                    $("#frequencySlider").slider({
                        ...
                        slide: function (event, ui) {
                            $("#frequencyScale").val(ui.value / 100);
                            scene.changeAttr("frequency");
                        }
                    });
                    $("#frequencyScale").val($("#frequencySlider").slider("value") / 100);
                    ...
                    $("#colorSlider").slider({
                        ...
                        value: 120,
                        slide: function (event, ui) {
                            $("#colorScale").val(ui.value/10);
                            scene.changeAttr("color");
                        }
                    });
                    $("#colorScale").val($("#colorSlider").slider("value")/10);
                    ...
                    $("#weightSlider").slider({
                        ...
                        value: 200,
                        slide: function (event, ui) {
                            $("#explosionWeight").val(ui.value);
                            scene.changeAttr("weight");
                        }
                    });
                    $("#explosionWeight").val($("#weightSlider").slider("value"));
                }));
                ...
                $('#btnNewPlanet').click(function () {
                    var checkAnim = $('#checkAnimate').is(':checked'),
                            planet = new Planet(),
                            aLight = new THREE.AmbientLight(0x101010),
                            dlight = new THREE.DirectionalLight(0xffffff, 0.2); //2.para = intensität
                    ...
                    $('#checkDayTexture').change(function () {
                        planet.changeTex("day");
                    });
                    $('#checkNightTexture').change(function () {
                        planet.changeTex("night");
                    });
                    $('#checkClouds').change(function () {
                        planet.changeTex("clouds");
                    });
                    scene.animate(false);
                    scene.animate(checkAnim);
                });
                ...
                $('#btnNewExplosion').click(function () {
                    ...
                    $('#frequencyScale').change(function () {
                        scene.changeAttr("frequency");
                    });
